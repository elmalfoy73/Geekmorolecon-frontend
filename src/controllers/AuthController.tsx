...
import {SignUpResponse, verResponse} from "../model/user/auth/SignUpResponse";
...
export class AuthController extends BaseController {
    ...
    async verification(user: SignUpRequest) {
        return await this.api<verResponse>("verify", user, "POST")
    }
